...
//Action
import { createStatusUserService } from '../../../store/action/statusUserAction';

//Alertas 
import Swal from 'sweetalert2';

function CreateStatusUser({ setView }) {
  ...
  const create = async () => {
    ...
    const responseData = await createStatusUserService(body);
