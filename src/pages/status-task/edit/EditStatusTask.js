...
//Actions
import { updateStatusTaskService } from "../../../store/action/statusTaskAction";

function EditStatusTask({ setView, infoUpdate }) {
    ...
    const edit = async () => {
        ...
        if (validateForm()) {
            let responseData = await updateStatusTaskService(body);
