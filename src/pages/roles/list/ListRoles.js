...
//View
import Create from '../create/CreateRole';
import Edit from '../edit/EditRole';
...
const ListRoles = () => {
  ...
  const rows = useSelector((store) => store.role);
  ...
  const handleDelete = async (id) => {
        const responseData = await deleteRoleService(id);
